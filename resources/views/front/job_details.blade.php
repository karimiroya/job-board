                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                          ...
                          <ul>
                              ...
                              <li>Location : <span>{{$company->city}},{{$company->address}}</span></li>
                              <li>Job nature : <span>{{$job->nature}}</span></li>
                              <li>category: <span>{{$job->category}}</span></li>
                              <li>Salary :  <span>{{$job->salary}}</span></li>
                          </ul>
                         <div class="apply-btn2">
                            <a  href="{{route('applyJob',$company->id)}}" class="btn">Apply Now</a>
                         </div>
                       </div>
                        <div class="post-details4  mb-50">
                           ...
                           <div class="small-section-tittle">
                              ...
                              <p>{{$company->descriptionCompany}}</p>
                            <ul>
                                <li>Name: <span>{{$company->nameCompany}} </span></li>
                                <li>Web : <span> {{$company->web}}</span></li>
                                <li>Email: <span>{{$company->emailCompany}}</span></li>
                            </ul>
                       </div>
                    </div>
                </div>
